...
class Oscar4(object):
  def __init__(self, ):
    ...
    jpype.startJVM(classpath = ['/usr/share/java/org.jpype-1.3.0.jar','/usr/share/java/log4j-1.2-1.2.17.jar','/usr/share/java/opennlp-tools.jar','./antlr-3.5.3-complete.jar','./antlr4-runtime-4.7.4.jar','./oscar4-all-5.2.0-with-dependencies.jar','./chemicalTagger-1.6.2.jar'])
